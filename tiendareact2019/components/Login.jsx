...
class LoginForm extends React.Component{
  ...
  checkLogin(event) {
    ...
    console.log(password);
      if(email === "josericaldi@gmail.com") {
      //if (userData !== null) {
    ...
    if (this.checkSession()){
      ...
      return(
        <div className="login row">
          <div className="col s3 form-container animated fadeIn slow">
            <form onSubmit={this.checkLogin}>
              <h4 className="text-center white-text">Iniciar Sesión</h4>
              <div className="col s12 input-field">
                <input type="email" ref="email" id="email" value={this.state.email} onChange={this.handleChange} placeholder="josericaldi@gmail.com" className="validate white-text" required aria-required="true" />
                <label htmlFor="email" data-error="Email Incorrecto" data-success="Email Correcto">Correo Electrónico</label>
              </div>
              <div className="col s12 input-field">
                <input type="password" ref="password" id="password" value={this.state.password} onChange={this.handleChange} placeholder="123456" className="validate  white-text" required aria-required="true" />
                <label> </label>
