      ...
      <div className="col s12 animated fadeIn fast">
          ...
          <div className="card-stacked">
            ...
            <div className="card-content">
              <div className="informacion blue-grey-text text-darken-2">
                ...
                <p><b>Precio: </b><FormattedMessage   id="precio"  defaultMessage={`S/. {precio, number}`} values={{precio : this.props.precio}}  /></p>
        ...
        <div className="card-action z-depth-2">
          <div className="no-padding col s12 right-align">
            <h5 className="animated pulse fast" ><b>Subtotal: </b> <FormattedMessage   id="subtotal"  defaultMessage={`S/. {subtotal, number}`} values={{subtotal : this.state.subtotal}}  /></h5>
          </div>
        </div>
      </div>
