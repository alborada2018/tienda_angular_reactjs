...
class Carrito extends React.Component{
            ...
            <div className="animated fadeIn slow">
              <div className="box carrito">
                ...
                <div className="col l4 m6 s12">
                  ...
                  <h5 className="right col s12 right-align animated pulse fast"> <FormattedMessage   id="total"  defaultMessage={`S/. {total, number}`} values={{total : this.total()}}  /></h5>
                  <p className="right">
          ...
          <div className="container">
            ...
            <div className="animated fadeIn slow">
              <div className="box white col s12 center-align" style={{padding: '5%'}}>
                <h5  style={{height : '70vh', display : 'table-cell', verticalAlign : 'middle'}} >Debes agregar productos al carrito de compras. Vuelve a <Link to="/tienda">"Super mercado La Bodega de Carmen"</Link></h5>
              </div>
            </div>
          </div>
        </div>
  ...
  pagarCarrito(){
    ...
    request
    .get('https://reactproductos.firebaseio.com/productos/.json') 
...
actualizarDB(itemCatalogo, cantidad){
  request.put(`https://reactproductos.firebaseio.com/productos/${itemCatalogo.id}.json`)  //Realizar consulta a base de datos
